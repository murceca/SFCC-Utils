...
const collectionUtils = proxyquire.noCallThru().load(
  '../../../../plugin_utils/cartridge/scripts/collectionUtils',
  {
    '*/scripts/iteratorUtils': iteratorUtils
  }
);

const { forEach, map, filter, reduce } = collectionUtils;
...
describe('collectionUtils', () => {
  ...
  describe('map function', () => {
    it('should call callback for each item in the collection and return new array', () => {
      ...
      const callbackSpy = sinon.spy(callback);
      const result = map(fakeData, callbackSpy);
  ...
  describe('filter function', () => {
    it('should call callback for each item in the collection and return new array', () => {
      ...
      const callbackSpy = sinon.spy(callback);
      const result = filter(fakeData, callbackSpy);
  ...
  describe('reduce function', () => {
    it('should call callback for each item in the collection and return sum', () => {
      ...
      const result = reduce(fakeData, callback, 0);
    ...
    it('should correctly handle reducing with no initial value', () => {
      ...
      const result = reduce(fakeData, callback);
      expect(result).to.equal(10);
    });
